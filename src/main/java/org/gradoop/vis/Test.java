...
public class Test {
    public static void main(String[] args) throws Exception {
        ...
        List<GraphHead> ls = g.aggregate(new VertexCount(),new EdgeCount()).getGraphHead().collect();
        System.out.println(ls.get(0).getPropertyValue("vertexCount"));
//        g.aggregate(new VertexCount())
